...
def getArgsParser():
    ...
    parser.add_argument('--dataloader', default='eth', help='kitti or dtu', choices=['kitti', 'dtu','eth'])
    # Data settings
    ...
    parser.add_argument('--nhypothesis_init', type=int, default=48, help='number of depth_hypos at coarse level')
